...
<title>Instansi/Petugas — <?= out(APP_NAME) ?></title>
  ...
  <div class="admin-main">
    ...
    <div class="admin-content">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;flex-wrap:wrap;gap:12px;">
        <div>
          <h1 style="font-size:22px;margin:0 0 4px;">Instansi / Petugas</h1>
          <p class="text-secondary" style="margin:0;font-size:14px;">Kelola akun petugas lapangan yang menangani laporan.</p>
        </div>
        <button class="btn btn-primary btn-sm" id="btn-add-user">+ Tambah Petugas</button>
      </div>
      ...
      <div class="admin-panel">
        ...
        <div style="overflow-x:auto;">
          <table class="admin-table">
            <thead><tr><th>Nama Petugas</th><th>Kontak</th><th>Wilayah</th><th>Status</th><th>Bergabung</th><th>Aksi</th></tr></thead>
...
<div class="admin-modal-overlay" id="user-modal-overlay">
  <div class="admin-modal">
    <h2 style="font-size:17px;margin:0 0 16px;" id="modal-title">Tambah Petugas</h2>
    <form id="user-form">
      <?= csrf_field() ?>
      <input type="hidden" id="user_id" value="">
      <div class="field"><label>Nama Lengkap Petugas</label><input class="input" id="f-nama" placeholder="Contoh: Budi Santoso (PU Bina Marga)" required></div>
      ...
      <div class="field"><label>Instansi / Alamat</label><textarea class="input" id="f-alamat" rows="2" placeholder="Contoh: Dinas Pekerjaan Umum"></textarea></div>
...
<script>window.BASE_URL = <?= json_encode(BASE_URL) ?>; window.USER_ROLE = 'petugas';</script>
